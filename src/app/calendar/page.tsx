        ...
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-8 px-6 py-16">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-3xl text-xl text-foreground/90">
              ...
              Slams down to the Challengers and ITF events where next
              year&apos;s stars are grinding right now. Filter by level and
              surface.
            </p>
          </div>
          <MascotExplainer pose="calendar">
            My favorite page — 11 months of tennis, zero weeks off. Each card
            shows the reigning champ and the final score from the last time
            the trophy was handed out.
          </MascotExplainer>
        </div>
      </section>
      <CalendarView />
